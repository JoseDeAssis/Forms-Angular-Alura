...
@NgModule({
  declarations: [AppComponent, HeaderComponent, FooterComponent, CadastroComponent, SucessoCadastroComponent, MensagemErroComponent, MaiorIdadeDirective, ValidandoCepDirective],
